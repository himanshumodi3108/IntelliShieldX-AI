  ...
  export const PRICING_PLANS = [
    {
      ...
      features: [
        ...
        "Basic threat intelligence (URLhaus, ThreatFox)",
      ...
      limitations: [
        "No AI remediation",
        "No VirusTotal/MalwareBazaar scanning",
        "No priority support",
      ],
    ...
    },
    {
      ...
      features: [
        ...
        "Enhanced threat intelligence (MalwareBazaar, VirusTotal - 10/day)",
    ...
    },
    {
      ...
      features: [
        ...
        "Advanced threat intelligence (VirusTotal 50/day, Hybrid Analysis 20/day, AbuseIPDB 100/day)",
        "Complete unified security reports with threat intelligence",
        "Priority email support",
        "PDF reports with signatures & threat intelligence",
        "API access",
    ...
    },
    {
      ...
      features: [
        ...
        "Complete threat intelligence suite (Unlimited VirusTotal, Hybrid Analysis 100/day, AbuseIPDB 1,000/day)",
        "Priority threat intelligence processing",
        "Advanced threat intelligence analytics",
        "Custom threat intelligence integrations",
        "API access for threat intelligence data",
